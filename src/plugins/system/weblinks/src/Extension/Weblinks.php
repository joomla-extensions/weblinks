...
final class Weblinks extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onAfterRender()
    {
        ...
        if ($option === 'com_categories' && $extension === 'com_weblinks' && $layout !== 'edit') {
            $helpUrl = 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joomla-extensions/weblinks/5.x-dev/help/' . $lang . '/weblinks-categories.html';
        ...
        if ($option === 'com_categories' && $extension === 'com_weblinks' && $layout === 'edit') {
            $helpUrl = 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joomla-extensions/weblinks/5.x-dev/help/' . $lang . '/weblinks-categories-edit.html';
        ...
        if ($option === 'com_weblinks' && ($view === 'weblinks' || $view === null)) {
            $helpUrl = 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joomla-extensions/weblinks/5.x-dev/help/' . $lang . '/weblinks-links.html';
        ...
        if ($option === 'com_config' && $view === 'component' && $component === 'com_weblinks') {
            $helpUrl = 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joomla-extensions/weblinks/5.x-dev/help/' . $lang . '/weblinks-options.html';
